...
namespace engine
{
    ...
    public:
        enum class key : uint8_t
        {
            ...
            escape, space, enter, tab, backspace, shift, leftShift, rightShift, control, leftControl, rightControl, alt, leftAlt, rightAlt, del,
            left, right, up, down,
        ...
        static inline state getKeyState(const key key) { return states[static_cast<size_t>(key)]; }

        static inline bool isKeyHeldDown(const key key) { return getKeyState(key) == state::heldDown; }

        static inline bool isKeyJustDown(const key key) { return getKeyState(key) == state::justDown; }

        static inline bool isKeyUp(const key key) { return getKeyState(key) == state::up; }
    ...
    private:
        ...
        static inline int getWindowsVirtualKeyCode_(const key key)
        {
            ...
            case key::gamePadA: return VK_GAMEPAD_A;
            case key::gamePadB: return VK_GAMEPAD_B;
            case key::gamePadX: return VK_GAMEPAD_X;
            case key::gamePadY: return VK_GAMEPAD_Y;
            case key::gamePadRightShoulder: return VK_GAMEPAD_RIGHT_SHOULDER;
            case key::gamePadLeftShoulder: return VK_GAMEPAD_LEFT_SHOULDER;
            case key::gamePadLeftTrigger: return VK_GAMEPAD_LEFT_TRIGGER;
            case key::gamePadRightTrigger: return VK_GAMEPAD_RIGHT_TRIGGER;
            case key::gamePadDpadUp: return VK_GAMEPAD_DPAD_UP;
            case key::gamePadDpadDown: return VK_GAMEPAD_DPAD_DOWN;
            case key::gamePadDpadLeft: return VK_GAMEPAD_DPAD_LEFT;
            case key::gamePadDpadRight: return VK_GAMEPAD_DPAD_RIGHT;
            case key::gamePadMenu: return VK_GAMEPAD_MENU;
            case key::gamePadView: return VK_GAMEPAD_VIEW;
            case key::gamePadLeftThumbstickButton: return VK_GAMEPAD_LEFT_THUMBSTICK_BUTTON;
            case key::gamePadRightThumbstickButton: return VK_GAMEPAD_RIGHT_THUMBSTICK_BUTTON;
            case key::gamePadLeftThumbstickUp: return VK_GAMEPAD_LEFT_THUMBSTICK_UP;
            case key::gamePadLeftThumbstickDown: return VK_GAMEPAD_LEFT_THUMBSTICK_DOWN;
            case key::gamePadLeftThumbstickRight: return VK_GAMEPAD_LEFT_THUMBSTICK_RIGHT;
            case key::gamePadLeftThumbstickLeft: return VK_GAMEPAD_LEFT_THUMBSTICK_LEFT;
            case key::gamePadRightThumbstickUp: return VK_GAMEPAD_RIGHT_THUMBSTICK_UP;
            case key::gamePadRightThumbstickDown: return VK_GAMEPAD_RIGHT_THUMBSTICK_DOWN;
            case key::gamePadRightThumbstickRight: return VK_GAMEPAD_RIGHT_THUMBSTICK_RIGHT;
            case key::gamePadRightThumbstickLeft: return VK_GAMEPAD_RIGHT_THUMBSTICK_LEFT;
